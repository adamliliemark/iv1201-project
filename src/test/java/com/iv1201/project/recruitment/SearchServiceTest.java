...
public class SearchServiceTest {
    ...
    public void listing_empty_applications_should_be_empty_list() throws Exception {
        ...
        List<ApplicationDTO> searchResult = searchService.getApplications(listFormMock, competences);
    ...
    public void listing_applications_on_range_should_be_correct() throws Exception {
        ...
        searchResult = searchService.getApplications(listFormMock, competences);
